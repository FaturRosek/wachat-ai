    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div 
          ...
          className={`bg-white border border-slate-200 rounded-2xl p-5 shadow-2xs hover:shadow-xs transition ${
        ...
        >
          ...
          {!isConnected && (
            <p className="text-[10px] font-bold text-blue-600 mt-1 hover:underline">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-slate-100 gap-3">
          <div className="flex items-center space-x-2.5">
            ...
            <span className={`inline-flex items-center space-x-1 px-2 py-0.5 rounded-full text-[10px] font-bold ${
              isConnected ? 'bg-emerald-50 border border-emerald-200 text-emerald-600' : 'bg-slate-100 border border-slate-200 text-slate-500'
            }`}>
          ...
          <div>
            ...
            <div className="space-y-2.5 text-xs">
              <div className="flex items-center justify-between py-1 border-b border-slate-100">
                ...
                <span className={`font-semibold ${isConnected ? 'text-emerald-600' : 'text-rose-500'}`}>
                  {isConnected ? 'CONNECTED' : 'OFFLINE'}
                </span>
              </div>

              <div className="flex items-center justify-between py-1 border-b border-slate-100">
                <span className="text-slate-500">Nomor HP Terkait</span>
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <span className="font-medium text-slate-800 font-mono">Pribadi (Per Akun)</span>
              </div>
            </div>
          </div>
        </div>
